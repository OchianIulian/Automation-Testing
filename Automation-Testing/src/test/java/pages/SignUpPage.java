...
public class SignUpPage {
    ...
    public void setTermAndConditionCheckbox(boolean isChecked){
    ...
    public void registerNewUser(String username,
        ...
        setTermAndConditionCheckbox(isTermsAndConditionsChecked);
